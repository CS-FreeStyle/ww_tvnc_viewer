...
public class CConn extends CConnection implements UserPasswdGetter,
  ...
  Thread rtsp_thread;	// ALTER
  RtspRunnable rtsp;	// ALTER

  // RFB thread
  public CConn(VncViewer viewer_, Socket sock_) {
	rtsp_thread = null; // ALTER
  ...
  public void serverInit() {
    ...
    rtsp = new RtspRunnable(desktop);	// ALTER
    rtsp_thread = new Thread(rtsp);		// ALTER
